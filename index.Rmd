...
title.innerHTML = title.innerHTML + '<br>' + '<br>' + '<img src="images/cover_photo.jpeg" alt="Test Image">' +
    '<figcaption style="font-size: 0.9em; color: gray; margin-top: 5px;">' + 'Image credit: <a href="https://www.pexels.com/photo/cherry-blossom-tree-932409/" target="_blank">Pexels</a>' + '</figcaption>' + '<br>' + '<br>' + '<p><em>This e-book is available also <a href="https://divergent-branches-fi.netlify.app/" target="_blank">in Finnish.</a> (Tämä kirja on luettavissa myös <a href="https://divergent-branches-fi.netlify.app/" target="_blank">suomeksi.)</a></em></p>'
